...
/**
 * A Bison parser, automatically generated from <tt>NanoLisp.y</tt>.
 *
...
/**
  ...
  if (yyn == 4)
    /* "NanoLisp.y":40  */
                        { l.show("LITERAL",((String)(yystack.valueAt (0)))); };
  break;
  ...
  if (yyn == 5)
    /* "NanoLisp.y":41  */
                        { l.show("NAME",((String)(yystack.valueAt (0)))); };
  break;
  ...
  if (yyn == 6)
    /* "NanoLisp.y":42  */
                                { l.show("IF",((String)(yystack.valueAt (0)))); };
  break;
  ...
  if (yyn == 7)
    /* "NanoLisp.y":43  */
                        { l.show("DEFINE",((String)(yystack.valueAt (0)))); };
  break;
  ...
  if (yyn == 8)
    /* "NanoLisp.y":44  */
                                { l.show("'('",((String)(yystack.valueAt (0)))); };
  break;
...
/* YYR2[YYN] -- Number of symbols on the right hand side of rule YYN.  */
  ...
  private static final String[] yytname_init()
  {
    return new String[]
    {
  "$end", "error", "$undefined", "LITERAL", "NAME", "IF", "DEFINE", "'('",
  "')'", "YYERRCODE", "$accept", "program", "token", null
    };
  }
  ...
  {
    int user_token_number_max_ = 262;
    byte undef_token_ = 2;
  ...
  private static final int yylast_ = 7;
